        ...
        <nav class="navbar navbar-inverse">
            <div class="container">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="" class="dropdown-toggle" data-toggle="dropdown">Đơn Hàng<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href="{{ route('order.index') }}">Đơn Hàng Đã Xác Nhận</a>
                            </li>
                            <li>
                                <a href="{{ route('order.index') }}?status=0">Đơn Hàng Chưa Xác Nhận</a>
                            </li>
                            <li>
                                <a href="{{ route('order.index') }}?status=2">Đơn Hàng Đã Giao</a>
                            </li>
                            <li>
                                <a href="{{ route('order.index') }}?status=3">Đơn Hàng Đã Hủy</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="{{ route('manager.logout') }}"><i class="fa-solid fa-right-from-bracket"></i></a></li>
                </ul>
            </div>
        </nav>
